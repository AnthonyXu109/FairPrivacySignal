...
echo "- docs/assets/movielens_marketplace_gallery.svg"
...
echo "- docs/assets/education_student_performance_gallery.svg"
...
echo "- docs/assets/finance_german_credit_gallery.svg"
...
echo "- docs/assets/healthcare_wdbc_gallery.svg"
...
echo "- docs/assets/public_services_adult_gallery.svg"
